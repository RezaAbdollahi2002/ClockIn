                        ...
                        <div>
                            {
                                ...
                                (
                                    <>
                                        <div className="border px-2 py-1 flex flex-col gap-y-10 hover:border-[#1a1365] hover:text-[#1a1365] hover:font-bold duration:300 ">
                                            <div className="text-sm md:text-medium px-2 py-1 flex gap-x-2 justify-between   ">
                                                <span key={index} className="text-black ">{day}</span>
                                                <button>
