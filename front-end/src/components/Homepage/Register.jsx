...
const Register = () => {
  ...
  return (
    <div className="grid grid-cols-1 h-full w-full md:grid-cols-2 bg-gradient-to-br from-[#2B0D59] via-[#5E1FBF] to-[#D473FF]">
      {/* Left */}
      <div className="flex flex-col justify-between px-6 py-10 gap-y-15 max-h-screen">
        <h1 className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white mb-4">ClockIn</h1>
        <div className="flex justify-center items-center">
          <img
            src={LogoImage}
            className="max-w-[90%] md:max-w-[450px] drop-shadow-xl bg-transparent"
          />
        </div>

        <div className="mb-30 md:my-15">
