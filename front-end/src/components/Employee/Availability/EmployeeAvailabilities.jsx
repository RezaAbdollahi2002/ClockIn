...
const EmployeeAvailabilities = ({ message, handleMessageState, setMessage, activeBot, setActiveBot }) => {
    ...
    const [showMyAvailabilitiesExist,setShowMyAvailabilitiesExist] = useState(false);
    ...
    const handleShowAvailabilities = async (e) => {
        ...
        try {
            ...
            if(res.data.length > 0 ){
                setShowMyAvailabilitiesExist(true);
            }
    ...
    return (
        <div className="relative max-h-screen">
            ...
            <div className="w-full min-h-screen p-3 px-2 shadow-lg border-gray-800 rounded-lg">
                ...
                {
                    showMyAvailabilities && showMyAvailabilitiesExist && (
